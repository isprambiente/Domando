...
ActiveRecord::Schema.define(version: 2022_01_22_233641) do
  ...
  create_table "faqs", force: :cascade do |t|
    ...
    t.index ["approve"], name: "index_faqs_on_approve"
    t.index ["counter"], name: "index_faqs_on_counter"
    t.index ["evidence"], name: "index_faqs_on_evidence"
    t.index ["structure"], name: "index_faqs_on_structure"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["structure"], name: "index_users_on_structure"
  ...
  add_foreign_key "user_faqs", "faqs", on_update: :cascade, on_delete: :cascade
  add_foreign_key "user_faqs", "users", on_update: :cascade, on_delete: :cascade
end
